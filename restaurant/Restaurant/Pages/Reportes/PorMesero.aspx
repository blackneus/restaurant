<%@ Page Title="" Language="C#" MasterPageFile="~/ReportesMaster.master" AutoEventWireup="true"
    CodeBehind="PorMesero.aspx.cs" Inherits="Restaurant.Pages.Reportes.PorMesero" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PropertiesContentPlaceHolder" runat="server">
    ...
    <div class="span2">
        <asp:Label ID="LblNomProyecto" Visible="True" runat="server" Text="Mesero"></asp:Label>
    </div>
    <div class="span10">
        <asp:DropDownList ID="DDLMesero" Width="350px" runat="server" Visible="True" AutoPostBack="true">
        </asp:DropDownList>
    </div>
    <div class="span2">
